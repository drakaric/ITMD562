...
function generateReminderOuput(reminder) {
	return { "title" : reminder.title, "description" : reminder.description, "created" : reminder.created };
}
...
app.get("/users/:userId", function(request, response) {
	var returnResponse = getUserById(request.params.userId);

	response.status(returnResponse.status).send(returnResponse.msg);
});

app.get("/users/:userId/reminders", function(request, response) {
	var returnResponse = getAllRemindersForUser(request.params.userId, request.query.title);
